  ...
  const tools: ToolDefinition[] = [
    {
      ...
      params: 'enter_plan_mode:{"task_description":"(规划任务描述)","max_steps":"(最大步骤数，本参数可不填)","require_approval":"(是否需要批准，本参数可不填)"}',
      category: 'plan',
    ...
    },
    {
      ...
      params: 'update_plan:{"tasks":"(数组，每项含description/tool/args)"}',
      category: 'plan',
    ...
    },
    {
      ...
      params: 'execute_plan:{"confirm":"(是否确认执行，boolean)"}',
      category: 'plan',
